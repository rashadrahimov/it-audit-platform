...
- **Текущая задача:** автономная сессия 18.07.2026 — T-019 закрыта; следующая — T-020 (enforcement; принесёт membership) или T-021/T-022/T-026.
- **Следующий шаг:** T-020 (enforcement + membership) — разблокирует T-012; параллельно открыты T-014 (TOTP), T-017, T-021, T-022, T-026.
- **Последнее готово:** **T-019 закрыта** (7 системных пресет-ролей с матрицами, сид под owner, мультиязычные имена). За сессию: T-006→007→040→041→042→010→011→013→018→019; `[!]`: T-012, T-043. GitHub-remote не заведён (CI: postgres для rls.spec). Открыто у заказчика: Excel-шаблоны, регулятор, оплата.
