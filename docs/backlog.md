...
- **Текущая задача:** T-039 закрыта (lifecycle с re-test, письма при назначении, суточные напоминания). Следующая — T-012 (групповые агрегаты + membership_scope).
- **Следующий шаг:** T-012 → T-044 (дашборды) → T-045 (экспорт). Открыто у заказчика: Excel-шаблоны, регулятор, оплата (гейтят остаток T-001).
- **Последнее готово:** **Марафон-2 18.07.2026: T-033, T-038, T-043, T-039.** До того марафон-1 — 12 задач и сессия решений (GitHub+CI зелёный).
...
- [ ] **T-012** — Групповой уровень: агрегирующие запросы по всем дочкам внутри тенанта, с проверкой прав; в скоуп входит `membership_scope` (какие дочки видит member). _Deps: T-011, T-013, T-020 (решение Рашада 18.07.2026 — deps выполнены, задача разблокирована)._ DoD: эндпоинт возвращает агрегат по группе, дочки друг друга не видят.
